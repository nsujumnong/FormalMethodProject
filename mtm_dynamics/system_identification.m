...
dh_link1 = [0 pi/2 0 q(1)-pi/2]; % 1
dh_link2 = [0.279 0 0 q(2)-pi/2]; % 1 to 2
dh_link2p = [0.1 0 0 q2p]; % 1 to 2p
dh_link2pp = [0.279 0 0 q2pp-pi/2]; % 2p to 2pp
dh_link3 = [0.365 -pi/2 0 q(3)+pi/2]; % 2 to 3
dh_link4 = [0 pi/2 0.151 q(4)]; % 3 to 4
dh_link5 = [0 -pi/2 0 q(5)]; % 4 to 5
dh_link6 = [0 pi/2 0 q(6)-pi/2]; % 5 to 6
dh_link7 = [0 0 0 q(7)]; % 6 to 7

dh_table = [dh_link1; dh_link2; dh_link3; dh_link4; dh_link5; dh_link6; dh_link7];
